 ...
 * @author TanNV
 */
@WebServlet(name = "DetailGuestServlet", urlPatterns = {"/DetailGuestServlet"})
public class DetailGuestServlet extends HttpServlet {

     final static Logger LOGGER = Logger.getLogger(DetailGuestServlet.class);
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("detailArticleGuest");
            rd.forward(request, response);
        } catch (Exception e) {
